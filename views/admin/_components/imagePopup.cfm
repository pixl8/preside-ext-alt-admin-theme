...
<cfoutput>
  ...
  <dialog class="c-image-popup" id="#args.id#">
    <div class="c-image-popup__wrapper">
      <button class="c-image-popup__close" aria-label="#args.closeLabel#">
        #renderView(
      ...
      <cfif len(args.image)>
        <img class="c-image-popup__image" src="#args.image#" alt="#args.imageAlt#" />        
      </cfif>
