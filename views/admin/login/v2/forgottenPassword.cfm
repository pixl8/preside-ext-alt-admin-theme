...
<cfscript>
	event.include( "/css/admin/altadmintheme-v2/pages/login-forgotten/" );
...
<cfoutput>
	<div class="p-login-forgotten">
		...
		<div class="p-login-forgotten__body">
			<cfif ListFindNoCase( "LOGINID_NOT_FOUND,INVALID_RESET_TOKEN,PASSWORD_RESET_INSTRUCTIONS_SENT", message )>
